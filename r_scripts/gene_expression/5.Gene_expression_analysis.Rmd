...
field_intensity <- field %>%
  filter(!delta_ct_cewe_MminusE == "NA")
...
speparam <-    
parasiteLoad::getParamBounds("normal", data = field_intensity, response = "delta_ct_cewe_MminusE")




Intensity_eimeria <- parasiteLoad::analyse(data = field_intensity,
...
bananaPlot(mod = Intensity_eimeria$H0,
