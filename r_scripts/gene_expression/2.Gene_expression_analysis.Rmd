...
result_field2 <- cbind(f, result_field)
```
...
descdisst(data = result_field, discrete = FALSE)
...
result_field <- cbind(result_field, result_field2$HI)
result_field <- cbind(result_field, result_field2$Sex)

result_field <- result_field %>%
  dplyr::rename(HI = 'result_field2$HI', Sex = 'result_field2$Sex')
...
# improve paramBounds
 speparam <- c(L1start = mean(stats::na.omit(result_field[["predictions_field"]])),
                     L1LB = min(stats::na.omit(result_field[["predictions_field"]])),
                     L1UB = max(stats::na.omit(result_field[["predictions_field"]])),
                     L2start = mean(stats::na.omit(result_field[["predictions_field"]])),
                     L2LB = min(stats::na.omit(result_field[["predictions_field"]])),
                     L2UB = max(stats::na.omit(result_field[["predictions_field"]])),
                     alphaStart = 0, alphaLB = -5, alphaUB = 5,
                     mysdStart = 1, mysdLB = 1e-9, mysdUB = 10)


 speparam <- speparam <- c(L1start = -16,
              L1LB = -16,
              L1UB = -6,
              L2start = -11,
              L2LB = -16,
              L2UB = -6,
              alphaStart = 0, alphaLB = -5, alphaUB = 5,
              mysdStart = 1, mysdLB = 1.e-9, mysdUB = 10.000000000)



min(stats::na.omit(result_field[["predictions_field"]]))
hist(result_field[["predictions_field"]])

speparam <- c(L1start = -12,
              L1LB = -20,
              L1UB = -10,
              L2start = -15,
              L2LB = -20,
              ...
              mysdStart = 1, mysdLB = 0.000000001 , mysdUB = 10.000000000)
