...
g.1 <- g %>% dplyr::select(c(all_of(Genes), max_WL,
                             primary_infection, challenge_infection, 
                             mouse_strain, Parasite_primary, Parasite_challenge, 
                             max_OOC, Eim_MC,  delta, Parasite_primary, 
                             Parasite_challenge, OPG_O))
...
g_minus <- g %>% 
  dplyr::select(-c(max_WL, primary_infection, challenge_infection, 
                  ...
                  Eim_MC, delta, Parasite_primary, Parasite_challenge, OPG_O, 
                  all_of(Genes)))
...
# save the model 
save(model_Parasite, file =  "r_scripts/models/predict_infecting_parasite")
...
# save the model 
save(model_mc, file =  "r_scripts/models/predict_mc_eimeria")
