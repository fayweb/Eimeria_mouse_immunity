...
immune_correlation <-  as.matrix(cor(immune, use="pairwise.complete.obs"))
...
#remove rows with only nas 
immune_correlation <-  immune_correlation[, colSums(is.na(immune_correlation)) != nrow(immune_correlation)]
...
### Data tidying for the heatmap function
immune <- immune_data  %>% 
  dplyr::select(-c(primary_infection, challenge_infection, infection_history, mouse_strain,
                   max_WL, delta, Parasite_challenge))
