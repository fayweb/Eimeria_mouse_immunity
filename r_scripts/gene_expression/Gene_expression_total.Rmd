...
g3 %>%
  pivot_longer(names_to = "genes", values_to = "expression", cols = everything()) %>%
  ggplot(aes(x = expression, y = expression, color = genes)) +
...
# this is a rather unsophisticated way to solve the problem
