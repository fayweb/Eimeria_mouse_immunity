...
# make a data frame with the mouse names
Mouse_ID <- as.data.frame(genes_mouse$Mouse_ID) %>%
  dplyr::rename(Mouse_ID = "genes_mouse$Mouse_ID")
...
field <- field %>%
  right_join(Mouse_ID, by = "Mouse_ID")
