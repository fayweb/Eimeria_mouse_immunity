...
![](7.PCA_heatmap_gene_field_files/figure-latex/unnamed-chunk-4-1.pdf)<!-- --> ![](7.PCA_heatmap_gene_field_files/figure-latex/unnamed-chunk-4-2.pdf)<!-- --> 
...
![](7.PCA_heatmap_gene_field_files/figure-latex/unnamed-chunk-5-1.pdf)<!-- --> 
...
![](7.PCA_heatmap_gene_field_files/figure-latex/unnamed-chunk-6-1.pdf)<!-- --> 
...
![](7.PCA_heatmap_gene_field_files/figure-latex/unnamed-chunk-7-1.pdf)<!-- --> 
...
![](7.PCA_heatmap_gene_field_files/figure-latex/correlations_genes_dimensions-1.pdf)<!-- --> 
...
![](7.PCA_heatmap_gene_field_files/figure-latex/contr_var_pc_genes-1.pdf)<!-- --> 
...
![](7.PCA_heatmap_gene_field_files/figure-latex/unnamed-chunk-10-1.pdf)<!-- --> 


![](7.PCA_heatmap_gene_field_files/figure-latex/contr_var_pc1_2_genes-1.pdf)<!-- --> 
...
![](7.PCA_heatmap_gene_field_files/figure-latex/pca_contribution_genes-1.pdf)<!-- --> 



To visualize the contribution of individuals to the first two principal components:

![](7.PCA_heatmap_gene_field_files/figure-latex/contr_individuals_genes-1.pdf)<!-- --> 
...
![](7.PCA_heatmap_gene_field_files/figure-latex/pca_biplot_genes-1.pdf)<!-- --> 
...
![](7.PCA_heatmap_gene_field_files/figure-latex/unnamed-chunk-12-1.pdf)<!-- --> 
