...
![](5.PCA_Heatmap_field_lab_GENE_files/figure-latex/unnamed-chunk-4-1.pdf)<!-- --> ![](5.PCA_Heatmap_field_lab_GENE_files/figure-latex/unnamed-chunk-4-2.pdf)<!-- --> 
...
![](5.PCA_Heatmap_field_lab_GENE_files/figure-latex/correlations_genes_dimensions-1.pdf)<!-- --> 
...
![](5.PCA_Heatmap_field_lab_GENE_files/figure-latex/contr_var_pc_genes-1.pdf)<!-- --> 
...
![](5.PCA_Heatmap_field_lab_GENE_files/figure-latex/unnamed-chunk-7-1.pdf)<!-- --> 


![](5.PCA_Heatmap_field_lab_GENE_files/figure-latex/contr_var_pc1_2_genes-1.pdf)<!-- --> 
...
![](5.PCA_Heatmap_field_lab_GENE_files/figure-latex/pca_contribution_genes-1.pdf)<!-- --> 



To visualize the contribution of individuals to the first two principal components:

![](5.PCA_Heatmap_field_lab_GENE_files/figure-latex/contr_individuals_genes-1.pdf)<!-- --> 
...
![](5.PCA_Heatmap_field_lab_GENE_files/figure-latex/pca_biplot_genes-1.pdf)<!-- --> 
...
![](5.PCA_Heatmap_field_lab_GENE_files/figure-latex/unnamed-chunk-9-1.pdf)<!-- --> 
