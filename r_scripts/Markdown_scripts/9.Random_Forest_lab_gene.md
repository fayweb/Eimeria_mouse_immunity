...
## 
## Call:
##  randomForest(formula = Parasite_challenge ~ ., data = train.data_parasite,      proximity = TRUE, ntree = 1500) 
...
![](9.Random_Forest_lab_gene_files/figure-latex/unnamed-chunk-15-1.pdf)<!-- --> 
