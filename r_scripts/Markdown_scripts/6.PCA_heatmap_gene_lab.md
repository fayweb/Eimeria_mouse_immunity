...
Part of the first figure in the publication.


```r
fviz_pca_var(res.pca, col.var = "cos2",
             gradient.cols = c("#DB6212", "#CC8733", "#5f25e6", "#073DA8"),
             repel = TRUE, title = "Principal Component Analysis of Immune Gene Expression in Laboratory-Controlled Eimeria Infections")
```
...
![](6.PCA_heatmap_gene_lab_files/figure-latex/unnamed-chunk-4-1.pdf)<!-- --> 
...
![](6.PCA_heatmap_gene_lab_files/figure-latex/unnamed-chunk-7-1.pdf)<!-- --> 
...
![](6.PCA_heatmap_gene_lab_files/figure-latex/unnamed-chunk-11-1.pdf)<!-- --> 
