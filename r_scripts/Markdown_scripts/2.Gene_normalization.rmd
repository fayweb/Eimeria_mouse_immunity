...
After normalization to the reference gene, we then transformed the DeltaCq values using an exponential function (2^(-DeltaCq)), a process known as exponential expression transform. This transformation allowed us to convert the values into relative expression levels, providing a clear representation of gene expression fold changes (Livak and Schmittgen, 2001).
