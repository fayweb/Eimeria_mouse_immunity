...
#ignore for now
Gene_lab   <- c("IFNy", "CXCR3", "IL.6", "IL.10", "IL.13", "IL.10", "IL.13", 
                "IL1RN", "CXCR3", "CASP1", "CXCL9", "IDO1", "IRGM1", "MPO", 
...
## Heatmap on lab gene expression 
...
## Heatmap on lab gene expression data: 
