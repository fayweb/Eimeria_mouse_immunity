...
std <- colnames(hm %>% dplyr::select(ends_with("_std"))) 
...
init <- mice(hm, maxit = 0, method = meth)
...
complete_hm <- complete(igf, 1)

#visualize missingness
vis_miss(complete_hm)
...
xyplot(igf, IFNy_std ~ SOCS1_std + IRGM1_std + MUC2_std, pch=18,cex=1)
...
xyplot(igf,IFNy_std ~ IL.10_std + PRF1_std + CASP1_std, pch=18,cex=1)
```
